...
import FreeDiagnosticsPage from "./pages/Services/FreeDiagnosticsPage.js";
import FreeDiagnosticsForm from "./pages/Services/FreeDiagnosticsForm.jsx";
    ...
    {/* <TasterSessionModal/> */}
      <FooterItemToTop>
        <Routes>
          ...
          <Route path="free-diagnostics" element={<FreeDiagnosticsPage />} />
          <Route path="FreeDiagnostics" element= {<FreeDiagnosticsForm />} />
