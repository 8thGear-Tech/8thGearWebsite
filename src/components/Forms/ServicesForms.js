...
Record && Record.map(record => {
    ...
    <div className='center'>   
            <h1 className="ManagedServicesRequestForm-Text mb-4">8thGear Hub -Request Form</h1>
                ...
                <div className="form-group my-4">
                    <input type="text" className="form-control" id="phonenumber" name="Phone-Number" onChange={(e) => setFormData({...formData, phoneNumber: e.target.value})} value={formData.phoneNumber} placeholder="Phone Number"></input>
                </div>
                <div className="form-group my-4">
                ...
                <div className="input-group">
                    ...
                    <select className="form-select" onChange={(e) => setFormData({...formData, serviceOfInterest: e.target.value})} value={formData.serviceOfInterest} type="text" name="serviceOfInterest" id="serviceOfInterest">
                        <option> </option>
                ...
                <div className="input-group">
                    ...
                    <select className="form-select" onChange={(e) => setFormData({...formData, optionalAddonsPlan: e.target.value})} value={formData.optionalAddonsPlan} type="text" name="optionalAddonsPlan" id="optionalAddonsPlan">
                        <option> </option>
                ...
                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                    ...
                    <label className="custom-control-label">Click to subscribe to our News Letter</label>
                </div>
