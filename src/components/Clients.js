...
const Clients = () => {
  return (
    <div className="client-section py-4">
      <Container>
        <Row className="justify-content-center text-center mb-4">
          <Col>
            <h2 className="section-title text-uppercase fw-semibold text-center fs-3 mt-5">Our Client</h2>
          </Col>
        </Row>
          ...
          {logos.map((logo, index) => (
            ...
            >
              <img
                src={logo.src}
                alt={logo.alt}
                className="img-fluid client-logo w-100 mx-2 h-100"
              />
            </Col>
          ))}
        </Row>
