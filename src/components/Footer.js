  ...
  return (
    <>
          ...
          <div>
            <a href="#" className="nav-link link-dark ">
              <img
                ...
                width={60}
                height={70}
                className="d-inline-block align-text-top mx-5 d-none d-lg-block d-md-none d-sm-none "
              />
            </a>
          </div>
          <ul className="nav me-auto">
            {/* <li className="nav-item d-none d-lg-block d-md-block d-sm-none">
              <a href="#" className="nav-link link-dark px-2">
                <img
                  src={logo}
                  alt=""
      ...
      <header className="py-3">
        <div className="container-fluid d-flex flex-wrap ">
          <ul className="nav me-auto align-items-center d-none d-lg-block d-md-none d-sm-none d-xs-none">
            <>
              <button
                type="button"
                class="btn"
              ...
              >
                ...
                <div className="">
                  <div className="d-flex justify-content-center ">
                    <hr className="my-0 " style={{ width: 210 }} />
                  </div>
                </div>
              </button>
              <div
          ...
          <ul className="nav align-items-center ">
            ...
            <li className="nav-link link-dark px-2">
              <a className="" href="#">
                <InstagramIcon />
              </a>
            </li>
            ...
            <li className="nav-item">
              <a href="tel:2348094818883" className="nav-link link-dark px-2">
                080 9481 8883
              </a>
            </li>
            <li className="nav-item">
              <a href="tel:2348094818882" className="nav-link link-dark px-2">
                080 9481 8882
              </a>
            </li>
            <li className="nav-item">
