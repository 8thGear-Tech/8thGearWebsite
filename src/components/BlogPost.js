...
export const BlogPost = () => {
    return (
       ...
       {CardData.mainCard.map((mainCards)=> {
        const {heroImage, date, text1, text2, text3, bodyImage, text4, id } = mainCards;
          return (
              <>
<div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" key={id}>
  <div className="offcanvas-header">
    <h5 className="offcanvas-title" id="offcanvasRightLabel">Blog</h5>
    <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
<div class="offcanvas-body d-lg">
            <header className=""><img src={heroImage}/></header>
            <div>
...
export const SideBlogPost = () => {
  return (
     ...
     {info.sideCrads.map((sideCrad)=> {
      const {heroImage, date, text1, text2, text3, bodyImage, text4, id } = sideCrad;
        return (
            <>
<div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" key={id}>
<div className="offcanvas-header">
