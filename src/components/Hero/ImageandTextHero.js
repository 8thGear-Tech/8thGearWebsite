...
export const ManageServicesDigitalMarketingHero = () => {
    return (
        <div className="ManageServicesDigitalMarketing text-center p-5">
            <h4>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque autem corrupti vitae neque quia
                exercitationem voluptatibus reiciendis. Voluptatibus, tenetur aut!
            </h4>
        </div>
    );
};
            ...
            <div className="row">
                <div className="col-lg-8 col-md-8 col-sm-12 ">
                    <h2 className="d-none d-lg-block d-md-block d-sm-block d-xs-none ms-5 heroTextColor">
                        As a rule, we build only default-alive ventures by doing things that scale so that we can have
                        enduring ventures.
                    </h2>
                ...
                <div className="row justify-content-center ">
                    <div className="col-lg-12 col-md-12 col-sm-12 ">
                        <h2 className="d-none d-lg-block d-md-none d-sm-none d-xs-none ms-5 heroTextColor text-center">
                            You are setting yourself up for growth when you are a member of a vibrant community where
                            people are continuously challenging and supporting one another.
                        </h2>
                        <h3 className="d-xs-block d-sm-block d-md-block d-lg-none heroTextColor text-center">
                            {" "}
                            You are setting yourself up for growth when you are a member of a vibrant community where
            ...
            <div className="container-fluid ManagedServicesLegalHeroBg d-flex align-items-center">
                <div className="px-3 container-fluid ManagedServicesLegalHeroBgg d-flex pt-3 pb-4">
                    <div className="row justify-content-center ">
                        <div className="col-lg-12 col-md-12 col-sm-12 ">
                            <h2 className="d-none d-lg-block d-md-none d-sm-none d-xs-none ms-5 heroTextColor text-center">
                                We at 8thGear are helpmates to your business and because we believe in the uniqueness of
                                every individual and business, we tailor our solutions to suit your needs and
                                aspirations.
                            </h2>
                            <h3 className="d-xs-block d-sm-block d-md-block d-lg-none heroTextColor text-center">
                                {" "}
                    ...
                    <div className="row justify-content-center text-center">
                        <div className="col-lg-9 col-md-12 col-sm-12">
                            <h2 className="d-none d-lg-block d-md-block d-sm-none d-xs-none heroTextColor text-center mt-5 ms-5">
                                It is important to travel the lonely path of entrepreneurship with like-minded
                                individuals. Synergy is created when founders collaborate, and individuals are inspired,
                                motivated, and challenged to pursue their dreams.
                            </h2>
                            <h3 className="d-xs-block d-sm-block d-md-none d-lg-none heroTextColor homeHeroTextTwo">
                                It is important to travel the lonely path of entrepreneurship with like-minded
                                individuals. Synergy is created when founders collaborate, and individuals are inspired,
                    ...
                    <div className="row justify-content-center ">
                        <div className="col-lg-8 col-md-12 col-sm-12 ">
                            <h2 className="d-none d-lg-block d-md-none d-sm-none d-xs-none ms-5 text-center">
                                Lörem ipsum startup teotris fysisk cd. Tukrogåligen transparens. Innovationskontor
                                biojäd, samt gamification.{" "}
                            </h2>
        ...
        <div className="container-fluid FUTAHeroBg">
            <div className="row align-items-center justify-content-center px-4 py-5">
                <div className="col-lg-6 col-md-7 col-sm-12 pt-3">
                    ...
                    <p className="mt-4">
                        Are you looking to enhance your employability, gain the necessary skills to pursue your dream
                        job, and stand out after graduation? You should attend the 8thGear FUTA Techpic Employability
                        Training
                    </p>
                ...
                <div className="col-lg-5 col-md-5 col-sm-12">
                    <img src={futatechpichero} className="d-block mx-lg-auto img-fluid" alt="" loading="" />
                ...
                <div className="row justify-content-start">
                    <div className="col-lg-10 col-md-8 col-sm-12 px-lg-5 ms-2">
                        ...
                        <p className="mt-2 text-white">
                            Empowering MSMEs: Your One-Stop shop for Digital Transformation and Business Growth!
                        </p>
                    </div>
