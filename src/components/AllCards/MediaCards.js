...
import {OnHoverReadMoreBtn, OnHoverReadMoreBtnThree, OnHoverReadMoreBtnTwo} from "../Buttons/ServicesBtn";
...
export const AllPortfoliosLogoCard = (props) => {
    ...
    return (
        <div className="align-items-center">
            <Link to={link}>
                <img className="my-5 logoEffect" src={logo} alt="Logo" style={{maxWidth: "100%", maxHeight: "100%"}} />
            </Link>
        </div>
    );
};
                ...
                <div className="card-body pb-3 px-3">
                    ...
                    <div className="text-center pt-4">
                        <Link to={link} className="text-decoration-none text-black">
                            {" "}
                            <p className="card-text text-decoration-underline" style={{color: "#821E6B"}}>
                                {" "}
                                <b>Read More </b>
                            </p>
                        </Link>{" "}
...
export const SingleMediaCards = (props) => {
    ...
    return (
        <>
            <img className="my-4 px-6 img-fluid" style={{width: 358.8}} src={image} alt={id} />
        </>
    );
};
...
export const SinglegalleryVideo = (props) => {
    ...
    return (
        <>
            <div className="card">
                <iframe src={video} height="280" allowFullScreen className="" alt="..." />
            </div>
        </>
    );
};
...
export const DigiPlusResponsibilityMatrixCards = (props) => {
    ...
    return (
        <>
            <div className="eightGearImg my-3 d-flex align-items-end" style={{backgroundImage: `url(${imageUrl})`}}>
