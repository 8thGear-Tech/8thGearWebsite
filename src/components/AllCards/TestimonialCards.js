...
export const ManagedServicesPageTestimonialCard = () => {
  return (
    ...
    // <div className="mt-4 ">
    // <h1 className="text-center h4">Testimonials</h1>
    // <div class="card mb-3 mx-auto w-50 mt-5">
    //   <div class="row g-0">
    //     <div class="col-md-6 ">
    //       <div className="ManagedServicesPageTestimonialCard">
    //         <img
    //           src={circle2}
    ...
    //         tailor our solutions to suit.
    //       </p>

    //       <p className="mx-3 text-white mt-5">
    //         <svg
    //           xmlns="http://www.w3.org/2000/svg"
    //           width="24"
    //           height="24"
