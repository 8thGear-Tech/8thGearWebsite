  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="d-flex justify-content-between mx-4 my-2">
        <img src={logo} width={50} className="" id="staticBackdropLabel"/>
...
<div class="modal-dialog">
  ...
  <div class="card-img-overlay">
    <div class="d-flex justify-content-between mx-1 my-1">
      <img src={logo} width={40} class="modal-title" id="staticBackdropLabel"/>
  ...
  <div className="cards">
          ...
          <br></br>
          <h4 class="">DAMILOLA OBIDAIRO</h4>
          <h6 className="">CO- FOUNDER</h6>
          <div class="card-body">
              <p class="card-text mb-4">dolor in reprehenderit in voluptate velit esse, cillum dolore eu fugiat nulla dolor in reprehenderit in voluptate velit esse
