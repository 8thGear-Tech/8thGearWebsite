    ...
    return (
        <div className='d-flex flex-column text-center align-items-center justify-content-center mx-auto my-5 howWeDoIt'>
            <div className='mx-5 py-5'>
                ...
                <p >We Transform problems into solutions, spin them off as ventures, and build sustainable businesses. currently we have 7 portfolio companies with 3 spun-off, aiming for 5 spin-offs by the end of 2024. Our portfolio includes</p>
            </div>
            <div className='my-3 container'>
                <div className='row mx-auto row-gap-5 justify-content-center'>
                    {cardDetails.map((c) => (
                        <div className='col-12 col-md-6 col-lg-4 d-flex justify-content-center'>
                            <PortfolioCards imgLink={c.imgLink} headText={c.headText} p1={c.p1} ps1={c.ps1} ps2={c.ps2} ps3={c.ps3} />
                        </div>
                    ))}
                </div>
            </div>
