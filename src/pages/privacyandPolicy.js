export const PrivacyAndPolicy = () => {
  return (
    <div className="privatePolicyBody">
      <div className="container-fluid PrivacyAndPolicyHero py-5 px-lg-5 px-md-5">
        <div className="row my-lg-3 mx-lg-3">
          <div className="d-none d-lg-block d-md-block d-sm-none">
            <h3 className="container">8thGear Privacy Policy</h3>
          </div>
          <div className="container-fluid d-lg-none d-md-none d-sm-block d-xs-block">
            <h3 className="text-center">8thGear Privacy Policy</h3>
          </div>
        </div>
      </div>
      <div className="container mt-5 PrivacyAndPolicyP">
        ...
        <p className="">
          8thGear Partners Limited (“we” or “us” or “our”) respects the privacy
          of our users (“user” or “you”). This Privacy Policy explains how we
          collect, use, disclose, and safeguard your information when you visit
          our website [www.8thgearpartners.com] quizzes, forms and survey
          platforms including any other media form, media channel, mobile
