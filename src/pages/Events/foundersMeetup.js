...
const FounderMeetupHero = () => {
  return (
    <div className="px-md-3 px-lg-5 py-md-3 py-lg-5 container-fluid heroSection">
      <div className="row align-items-center">
        {/* LEFT SECTION */}
        <div className="col-lg-6 col-md-6 col-12 text-md-start mb-4 mb-md-0">
          <div className="w-100 d-flex flex-column align-content-center px-2 py-2 mt-0">
            ...
            <h2
              className="text-start d-none d-lg-block d-md-none d-sm-none d-xs-none"
              style={{ color: "#000" }}
            >
              Founder's Meet up: CONNECT WITH CO-FOUNDERS, MEET POTENTIAL
              CLIENTS.
            </h2>
            <h3
              className="text-start d-xs-block d-sm-block d-md-block d-lg-none"
              style={{ color: "#000" }}
            >
              Founder's Meet up: CONNECT WITH CO-FOUNDERS, MEET POTENTIAL
              CLIENTS.
            </h3>
            <p className="fs-5 pt-4 text-start">
              Build valuable connections with entrepreneurs.
            </p>
          </div>
          ...
          <div className="">
            <div className="d-flex">
              {/* Date */}
              <div className="p-2 details d-flex align-items-center">
                <Image
                  src={CalendarIcon}
                  alt="Calender"
                  className="event-icon"
                />
                <span style={{ fontSize: "1rem" }}>TBD</span>
              </div>
              {/* Time */}
              <div className="p-2 details d-flex align-items-center">
            ...
            {/* Location */}
            <div className="py-2 details d-flex align-items-center">
              <Image src={locationPin} alt="icon" className="event-icon" />
              <span style={{ fontSize: "1rem" }} className="">
        ...
        {/* RIGHT SECTION */}
        <div className="col-lg-6 col-md-6 col-12 text-center order-md-2 order-1">
          <Image src={foundersheropic} alt="Hero-Pic1" className="img-fluid" />
        </div>
      </div>
    </div>
  );
};
// const FounderMeetupHeroo = () => {
//   return (
//     <div className="px-md-3 px-lg-5 py-md-3 py-lg-5 container-fluid heroSection d-flex justify-content-between align-items-center w-100 overflow-hidden">
//       {/* LEFT SECTION */}
...
//             Founders Meet up: FIND CO-FOUNDERS, MEET POTENTIAL CLIENTS.
//           </h1>
...
//               8thGear Hub, CMD Road ,Magodo Secetariat, Lagos State.
//             </span>
//           </div>
//         </div>
//       </div>
      ...
      <div className="container-fluid d-flex mt-5 w-100 mt-sm-1 mx-sm-0 flex-column flex-wrap event-content">
        <section className="w-75 mx-lg-5 m-md-3 mx-sm-0 px-sm-2 event-section">
          ...
          <div className="seection-one ">
            <p>
              Founders Meetup is all about bringing Entrepreneurs, and those
              curious about Startups, together to share ideas while learning
              from each other! Some sessions have guest speakers and others have
              a topic of discussion the attendees focus on.
            </p>
          </div>
          {/* WHO SHOULD ATTEND */}
          <div className="section-two mt-5 mb-3">
            ...
            <ul>
              ...
              <li>
                <p className="no-list">
                  Freelancers & service providers (digital marketers, web
                  developers, designers, etc.)
                </p>
              </li>
              <li>
                <p className="no-list">
                  Solo founders looking for founding team members
                </p>
              </li>
              <li>
                <p className="no-list">
                  Aspiring entrepreneurs who are either looking for one or more
                  co-founders
                </p>
              </li>
              <li>
                <p className="no-list">
                  Anyone who wishes to expand their business network
                </p>
              </li>
            </ul>
            <div>
              <p>
                This event is free to attend. Join us for a fun day! For more
                startup events, visit this{" "}
                <a
                  href="https://8thgearpartners.com/events"
              ...
              Feel free to invite other founders to join us as we meet every
              quarter!
            </div>
          </div>
          ...
          >
            ...
            <div className="registercontent">
              <p className="m-0">Regiter for this event here: </p>
              <a
                href="https://forms.gle/1hhrASfJwKEy6RpHA"
                target="_blank"
                className="m-0"
              >
                Link
          ...
          {/* <div className="speaker my-5 mx-lg-0 ">
            <h3 className="mb-3 align-content-center">SPEAKERS</h3>
...
//       </p>
//       <p>
//         We realize how difficult it can be to be an entreprene ur. Bravo, we are
...
//         expect. 8thGear’s Founder's Meetup was specially curated for you, we
