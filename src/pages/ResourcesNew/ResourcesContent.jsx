      ...
      <div className="d-none">
        ...
        <div className='container'>
          <div className='row vids g-0'>
            ...
            <div className='col-12 col-md-6'>
              <Button
                className={`button-custom ${activeSection === 'startingYourBusiness' ? 'button-active' : ''}`}
            ...
            <div className='col-12 col-md-6 mx-auto'>
              <Button
                className={`button-custom ${activeSection === 'growingYourBusiness' ? 'button-active' : ''}`}
        ...
        <div className='mt-5'>
          {activeSection === 'knowledgeCenter' && renderVideos(data.knowledgeCenter)}
          {activeSection === 'startingYourBusiness' && renderVideos(data.startingYourBusiness)}
          {activeSection === 'growingYourBusiness' && renderVideos(data.growingYourBusiness)}
        </div>
      </div>
