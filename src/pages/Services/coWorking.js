            ...
            <BookNowBtn />
                ...
                <div className="container-fluid CoworkingOffersBg py-5 px-5">
                    <div className="container-fluid CoworkingOffersBgg">
                        <div className="">
                            <h4 className="Gear coworkingBookText d-flex justify-content-end">The Gears You Require</h4>
    ...
    return (
        <>
            <div className="text-center mt-5">
                ...
                <div className="mx-3">
                    <button onClick={() => setActive("firstButton")} className="DailyandWeekendBundleBtn mx-2 mt-3">
                        Monthly/Yearly Plan
                    </button>

                    <button onClick={() => setActive("secondButton")} className="MeetingRoomBundleBtn mx-2 mt-3">
                        {" "}
                        Flexi Plan
                    </button>
                    <button onClick={() => setActive("thirdButton")} className="MeetingRoomBundleBtn mx-2 mt-3">
                        {" "}
                        Event/Training Hall
                    </button>
                </div>
                    ...
                    <th scope="col">MEETING ROOM(up to 8 persons)</th>
                                ...
                                <tbody>
                                    <tr className="letter">
                                        ...
                                        <td scope="col" colSpan="3" style={{verticalAlign: "middle"}}>
                                            {" "}
                                            WEEKDAYS (9am - 5pm)
                                        </td>
                                        <td scope="col" rowSpan="2" className="mt-3" style={{verticalAlign: "middle"}}>
                                            SATURDAYS (10am - 5pm){" "}
                                        </td>
                                        <td scope="col" rowSpan="2" style={{verticalAlign: "middle"}}>
                        ...
                        <div className="table-responsive">
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="finish">Amount</td> <td className="Pin"> ₦20,000(Per Hour)</td>
    ...
    return (
        <>
            <div className="container-fluid">
                <h2 className="text-center pt-5" style={{color: " #821e6b"}}>
                    OUR CO-WORKING SPACES
                </h2>
                <p className="text-center">Three locations, same excellent customer service</p>
                <div className="container">
                    {/* DON'T FORGET TO PUT BACK THE CODE........*/}
                    <VideoPlaceHolder />
                </div>
            </div>
        </>
...
const VideoPlaceHolder = () => {
    <div className="justify-center align-items-center m-auto">
        <h2>Example Video</h2>
        <video width="300px" height="200px" controls>
            <source src="../../public/images/coworking/Mr Dami shoutout video.mov" type="video/mp4" />
    ...
    return (
        <>
            <div className="container-fluid BGG">
                <h3 className="text-center pt-5">LAGOS INNOVATES: FREE WORKSPACE VOUCHER</h3>
                <p className="text-center">
                    Redeem your workspace voucher
                    <a href="https://forms.gle/pjR1os5hN6WnbzFa9" target="_blank" style={{color: "#821e6b"}}>
                        {" "}
                        here
                    </a>
