...
const GaaSNew = () => {
  return (
    ...
    >
      <div className="row align-items-center justify-content-center text-center text-md-start mt-md-5">
...
const WhyChooseUs = () => {
  ...
  return (
    <div className="container-fluid text-center py-5 px-5 mx-0">
      <h4 className="text-center mb-5 text-uppercase" style={{ color: '#6E005A' }}>
        Why Choose Us
      </h4>
...
const WhatWeDo = () => {
  ...
  const whatWeDoItems = [
    {
      title: "Advisory",
      description: "Our team of seasoned advisors provides strategic guidance and insights tailored to your unique business challenges. We help you navigate complex business environments and make informed decisions that drive growth.",
      imageUrl: "./images/team/damilolaobidairo1.png"
    },
    {
      title: "Networking",
      description: "We connect you with a vast network of industry experts, potential partners, and investors. Our extensive connections open doors to new opportunities and collaborations that can accelerate your business growth.",
      imageUrl: "./images/team/damilolaobidairo1.png"
    },
    {
      title: "Growth Strategy",
      description: "We work closely with you to develop and implement a comprehensive growth strategy. This includes market analysis, competitive positioning, product development, and customer acquisition tactics designed to drive sustainable growth.",
      imageUrl: "./images/team/damilolaobidairo1.png"
    },
    {
      title: "Deal Management",
      description: "Our GaaS service includes expert deal management support. We help you identify, negotiate, and close deals that align with your growth objectives, ensuring you get the best value and strategic fit for your business.",
      imageUrl: "./images/team/damilolaobidairo1.png"
    }
  ];
          ...
          <div className="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 d-flex justify-content-center" key={index}> 
            ...
            <div className="card d-flex flex-column h-auto border-0" style={{ width: '100%', maxWidth: '250px' }}>
              ...
              <div className="card-body d-flex flex-column" style={{ padding: '15px' }}>
                <h5 className="card-title text-start fs-5" style={{ marginBottom: '5px' }}>{item.title}</h5>
                <hr style={{ margin: '5px 0' }} />
                <p className="card-text text-start" style={{ fontSize: '0.9rem', lineHeight: '1.6', marginBottom: '0' }}>{item.description}</p>
              </div>
            </div>
          </div>
        ))}
      </div>
      <button className="btn btn-primary mt-4 rounded-pill py-2 px-4 fs-5 whatButton" style={{ color: '#D3D3D3' }}>
        Book a Growth Session
      </button>
    </div>
  );
  ...
  const steps = [
    {
      ...
      description: 'We begin with a deep dive into your business to understand your goals, challenges, and market environment. We use Discovery Calls and Discovery Forms to help us tailor our services to your specific needs.'
    },
    {
      id: 2,
      title: 'STRATEGY DEVELOPMENT',
      icon: './images/gaasImage/gaasicon2.png',
      description: 'Our team collaborates with you to develop a customized growth strategy. We focus on actionable steps that can drive immediate and long-term results.'
    },
    {
      id: 3,
      title: 'IMPLEMENTATION',
      icon: './images/gaasImage/gaasicon3.png',
      description: 'We support you in implementing the strategy, providing hands-on assistance in key areas such as marketing, sales, and operations. Our team ensures that the plan is executed effectively and efficiently.'
    },
    {
      id: 4,
      title: 'MONITORING & OPTIMISATION',
      icon: './images/gaasImage/gaasicon4.png',
      description: 'We continuously monitor your progress and optimize the strategy as needed. Regular check-ins and performance reviews help us stay on track and make necessary adjustments to maximize growth.'
    },
    {
      id: 5,
      title: 'SCALING UP',
      icon: './images/gaasImage/gaasicon5.png',
      description: 'As your business grows, we help you scale operations, enter new markets, and expand your customer base. Our goal is to ensure sustained growth and long-term success.'
    }
  ];
  ...
  return (
    <div className="container-fluid py-5 px-5">
      <div className="row text-center">
        <h2 className="mb-4 fs-4" style={{ color: '#6E006A' }}>OUR PROCESS</h2>
      </div>
      <div className="row justify-content-center px-sm-1 px-md-2 px-lg-5">
        {steps.map(step => (
          ...
          >
            <div className="card d-flex flex-column h-100 text-center border-0 rounded-4 p-3" style={{ backgroundColor: '#F7F2F7' }}>
              <div className="card-body d-flex flex-column justify-content-center align-items-center">
                <img src={step.icon} alt={step.title} className="mb-3" style={{ height: '50px', width: 'auto' }} /> {/* Center icon */}
                <h5 className="card-title" style={{ color: '#6E006A', fontWeight: 'bold' }}>{step.title}</h5>
                <p className="card-text text-muted" style={{ fontSize: '0.9rem', width: '100%' }}>{step.description}</p>
              </div>
            </div>
          </div>
        ))}
  ...
  const successStories = [
    {
      id: 1,
      title: 'CASE STUDY 1',
      description: `From Startup to Market Leader, we helped Company A develop a growth strategy that took them from a small startup to a market leader in their industry. Through targeted marketing campaigns, strategic partnerships, and operational optimisation, Company A saw a 300% increase in revenue within two years.`,
      image: './images/gaasImage/talent_fair_18.JPG' 
    },
    {
      id: 2,
      title: 'CASE STUDY 2',
      description: `Expansion into New Markets. Company B sought to expand into new markets but faced several challenges. Our team provided the necessary market research, strategic guidance, and networking opportunities. As a result, Company B successfully entered three new markets and increased its customer base by 50%.`,
      image: './images/gaasImage/foundersmeetupsix.jpg' 
    }
  ];

  return (
    <div className="container-fluid py-5 px-1 px-md-5" style={{ backgroundColor: '#6E006A', color: '#fff' }}>
      <div className="row text-center mb-5">
        <h2 className="col-12 fs-4">OUR SUCCESS STORIES</h2>
      </div>

      {successStories.map((story, index) => (
        <div key={story.id} className="row align-items-center mb-5 px-5 mx-md-0 px-md-1 px-lg-5">
          {index % 2 === 0 ? (
            <>
            ...
            <>
              ...
              <div className="col-md-6 col-sm-12 mb-4 order-md-2 ps-lg-5">
                <h5 className="fw-bold">{story.title}</h5> {/* // Added Bootstrap class for bold text */}
                <p className="text-wrap">{story.description}</p> {/* // Added text-wrap class for responsive text */}
              </div>
...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      quote: "8thGear Hub's GaaS service transformed our business. Their strategic guidance and hands-on support were invaluable in achieving our growth objectives.",
      author: 'CEO, Company A',
      image: './images/team/damilolaobidairo.png' 
    },
    {
      id: 2,
      quote: "The team at 8thGear Hub helped us navigate complex market conditions and provided the tools we needed to succeed. We couldn't have done it without them.",
      author: 'Founder, Company B',
      image: './images/team/damilolaobidairo.png' 
    },
    {
      id: 3,
      quote: 'Amazing experience! The service exceeded my expectations and delivered exactly what I needed on time.',
      author: 'Jane D.',
      image: './images/team/damilolaobidairo.png' 
    },
    {
  ...
  return (
    <div className="container my-5">
      <div className="row text-center mb-4">
        <h2 className="col-12 fs-4" style={{ color: '#6E006A' }}>TESTIMONIALS</h2>
      </div>
      <div className="row justify-content-center">
...
const GaasReady = () => {
  return (
    <div className="container-fluid py-5" style={{ backgroundColor: '#6E006A', color: 'white' }}>
      <div className="text-center">
        {/* Heading with responsive font size */}
        <h2 className="fw-bold mb-3 fs-4 fs-md-3 fs-lg-2">READY TO ACCELERATE YOUR GROWTH?</h2>
        
        {/* Paragraph with responsive padding */}
        <p className="mb-4 px-md-4 mx-lg-5 text-wrap readyParagraph">
          Fill out this form and contact us today to learn more about our Growth-as-a-Service (GaaS)
          offerings and how we can help your business achieve its growth potential.
        </p>
        
        {/* Button with responsive padding */}
        <button className="btn btn-outline-light rounded-pill px-3 px-md-4 py-2 fs-5 readyButton" style={{
          borderColor: '#D3D3D3',
          color: '#D3D3D3'
