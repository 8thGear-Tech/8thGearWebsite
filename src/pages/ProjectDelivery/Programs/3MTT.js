      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6 mb-4 mb-lg-0">
            ...
            <p className="mb-4">
              Tap into Nigeria's largest tech talent pipeline. Get trained AI and Data Science professionals ready to drive your business growth.
            </p>
            ...
            <div className="hero-cta">
              <a href="https://forms.gle/ehFzYU6fiDFyZ2Qb7" target="_blank" rel="noopener noreferrer" className="btn btn-primary-8th btn-lg">
                Get Talent Now
              </a>
          ...
          <div className="col-lg-6 mb-4 mb-lg-0">
            <div className="overview-content">
              <p className="lead-text">
                The <strong>Three Million Technical Talent (3MTT)</strong> programme is a Federal Government initiative training three million Nigerians in digital and technical skills.
              </p>
          ...
          <div className="col-lg-6">
            <div className="impact-cards">
              <div className="impact-card">
                ...
                <p>Trained talent means shorter onboarding and faster ROI on your hiring decisions</p>
              </div>
              <div className="impact-card">
                <div className="impact-icon">
