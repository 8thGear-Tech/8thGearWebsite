...
const MADHero = () => {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(130, 30, 107, 0.05) 0%, rgba(130, 30, 107, 0.15) 100%)",
      }}
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 col-md-12 mb-4 mb-lg-0">
            <div className="pe-lg-4">
              <h2 className="fw-bold mb-3">Migrant Advisory Desk</h2>
              ...
              <div className="row g-3 mb-4">
                <div className="col-md-6">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <h6 style={{ color: "#681955", marginBottom: "0" }}>
        ...
        <Row className="justify-content-center">
          <Col lg={10}>
            <div className="text-center mb-4">
              <h3 className="fw-bold">What is the Migrant Advisory Desk?</h3>
              <p className="text-muted">
                Making informed decisions about skills, livelihoods, and
                migration
              </p>
            </div>
            ...
            <Card className="border-0 shadow-sm mb-5 px-4">
              <p
                className="mb-3"
                style={{ lineHeight: "1.9", color: "#4a5568" }}
              >
                The <strong>Migrant Advisory Desk (m.A.D)</strong> is a
                structured counselling and profiling platform developed by GIZ
                and implemented by 8thGear to empower young people, especially
                those not in education, employment, or training (NEETs) to make
                informed decisions about skills, livelihoods, and migration.
                Through m.A.D, 8thGear supports MSMEs by connecting them with
                trained, job-ready talent that meets their specific workforce
                needs.
              </p>
              <p
                className="mb-0"
                style={{ lineHeight: "1.9", color: "#4a5568" }}
              >
                Using guided interviews and data-driven tools, we assess
                individual backgrounds, interests, and constraints, then link
                participants to appropriate training, employment, or enterprise
                pathways. For MSMEs, we provide direct access to a pool of
                skilled, motivated candidates while reducing uninformed
                migration and improving long-term economic outcomes for
            ...
            <Row className="g-4">
              <Col md={4}>
                ...
                >
                  ...
                  <p className="text-muted mb-0">
                    Guided assessments to understand unique skills and
                    aspirations
                  </p>
                </Card>
              </Col>
              ...
              <Col md={4}>
                ...
                >
                  ...
                  <p className="text-muted mb-0">
                    Direct connections to training, jobs, and migration
                    opportunities
                  </p>
                </Card>
              </Col>
...
const MADServices = () => {
  const services = [
    ...
    },
    {
      ...
      title: "Job Placement",
      description:
        "Direct connections to employment opportunities through our extensive employer network and partnerships.",
      color: "#9C27B0",
    },
    {
      icon: "🏠",
    ...
    },
    {
      ...
      description:
        "Data-driven insights on skills demand, market gaps, and employment trends to guide your decisions.",
      color: "#009688",
    },
  ];
    ...
    >
      <Container>
        <div className="text-center mb-5">
          <h3 className="fw-bold mb-2">Our Services</h3>
          <p className="text-muted">Comprehensive support for your journey</p>
        </div>
...
const MADWhoWeServe = () => {
  const targetGroups = [
    ...
    },
    {
      ...
      description:
        "Unemployed and underemployed young people seeking career opportunities and skills development",
      icon: "👥",
    },
    {
      title: "Prospective Migrants",
      description:
        "Individuals seeking structured pathways to study, vocational training, or work in Germany",
      icon: "✈️",
    },
    {
      title: "Returnees from Germany/Europe",
      description:
        "Migrants requiring reintegration support and access to local opportunities",
      icon: "🏠",
    },
    {
      title: "Training Providers & Sponsors",
      description:
        "Organizations seeking direct access to motivated, ready participants",
      icon: "🎓",
    },
  ];
    ...
    <section style={{ paddingTop: 80, paddingBottom: 80, background: "#fff" }}>
      <Container>
        <div className="text-center mb-5">
          ...
          <p className="text-muted">
            Our comprehensive approach to migration advisory and talent
            development
          </p>
        </div>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    height: "50px",
                    background:
                      index === steps.length - 1 ? "#fff" : PRIMARY_PURPLE,
                ...
                <div style={{ marginTop: "20px" }}>
                  ...
                  <p
                    className="mb-0"
                    style={{ opacity: index === steps.length - 1 ? 0.95 : 1 }}
                  >
                    {step.description}
                  </p>
                </div>
        ...
        <Row className="justify-content-center text-center">
          <Col lg={8}>
            ...
            <p className="mb-4" style={{ lineHeight: "1.8" }}>
              Whether you're an MSME seeking trained talent, a jobseeker
              planning your career, considering migration, need reintegration
              support, or looking to access our talent pool, the Migrant
              Advisory Desk is here to guide you every step of the way.
            </p>
