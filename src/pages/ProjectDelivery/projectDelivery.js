        ...
        <div className="container-fluid">
            <div className="container ">
                <div className="row justify-content-evenly ">
                    <h2 className="pt-5 text-center text-heading purple-text pb-2">WE PROMISE YOU...</h2>
                    ...
                    <div className="col-lg-4 col-md-6 mt-4 mb-5 px-4 d-flex">
                        ...
                        {Data.ProjectDeliveryContentThree.map((ProjectDeliveryContent) => {
                            return (
                                <NewProjectDeliveryCardThree {...ProjectDeliveryContent}></NewProjectDeliveryCardThree>
                            );
                        })}
                    </div>
                </div>
